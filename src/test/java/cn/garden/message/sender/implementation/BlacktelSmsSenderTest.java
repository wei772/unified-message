 ...
 * @author liwei
 */
public class BlacktelSmsSenderTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(BlacktelSmsSenderTest.class);

    @Test
    public void send() {
        BlacktelSmsSender smsSender = new BlacktelSmsSender();
